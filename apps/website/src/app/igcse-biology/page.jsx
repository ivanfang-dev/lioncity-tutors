...
export const metadata = {
  title: 'IGCSE Biology Guide 2026: Core, Extended & Practical',
    ...
    <>
      <GuideSchema
        ...
        course={{
          ...
          description:
            'Cambridge IGCSE Biology tuition in Singapore, covering the core and extended syllabus and the practical paper.',
      ...
      <div className="mx-auto max-w-2xl lg:max-w-none lg:grid lg:grid-cols-[minmax(0,42rem)_15rem] lg:justify-center lg:gap-12">
        ...
        <div>
          ...
          <article className="space-y-12 text-gray-700 leading-relaxed">
            ...
            {/* Conversion block */}
            <RelatedGuides slug="igcse-biology" />
