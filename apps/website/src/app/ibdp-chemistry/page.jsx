  ...
  return (
    ...
    <main className="mx-auto max-w-6xl px-4 sm:px-6 py-12 sm:py-16">
      <div className="mx-auto max-w-2xl lg:max-w-none lg:grid lg:grid-cols-[minmax(0,42rem)_15rem] lg:justify-center lg:gap-12">
        ...
        <div>
          <GuideHeader
            title="IBDP Chemistry Guide 2025: Master Physical, Organic & Inorganic Chemistry"
          ...
          <article className="space-y-12 text-gray-700 leading-relaxed">
            ...
            <GuideCTA
              ...
              description="Tell us your child’s level and goals. We hand-match a vetted, MOE-familiar IBDP Chemistry tutor — usually within hours — and parents never pay an agency fee."
