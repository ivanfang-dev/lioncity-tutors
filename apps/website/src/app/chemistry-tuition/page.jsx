      ...
      <div className="p-4 sm:p-6 max-w-5xl mx-auto space-y-8 sm:space-y-12">
        ...
        <section className="text-center space-y-3 sm:space-y-4">
          ...
          <Link href="/request-tutor">
            <Button className="h-auto text-[18.7px] font-bold px-6 sm:px-8 py-3 sm:py-4 mt-3 sm:mt-4 bg-accent-fill hover:bg-accent-fill-hover text-white rounded-full shadow-lg transform hover:scale-105 transition-all duration-200">
        ...
        <GuideCTA
          ...
          whatsappHref={`https://wa.me/6588701152?text=${encodeURIComponent("Hi LionCity Tutors! I'd like help finding a Chemistry tutor.\n\nStudent level:\nCurrent grade:\nLocation:\nPreferred days & timing: ")}`}
        />
      </div>
    </>
  );
