    ...
    return (
      <>
        ...
        <section ref={formRef} className="bg-gradient-to-br from-blue-50 to-sky-50 p-8 rounded-2xl shadow-lg">
          ...
          {/* Section 4 (subject guides) is now rendered by <RelatedGuides>,
              which sources all cluster spokes and their anchor text from
              src/lib/seo/clusters.mjs instead of hardcoding them here. */}
